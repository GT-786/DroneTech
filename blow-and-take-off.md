...
//Add your repeated code here
	...
	if(ABS(finalreading)>8)
	{
		LED.set(RED, ON);
		Command.arm();
		DesiredPosition.set(Z,250); //set drone altitude to 250cm

	}

	initialreading=((initialreading*0.9)+(currentreadings*0.1)); //updating the initial pressure each time
